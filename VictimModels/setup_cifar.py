...
class CIFARModel:
    def __init__(self, restore, session=None):
        ...
        model.add(Conv2D(48, (3, 3), input_shape=(32, 32, 3), activation='relu'))
        model.add(Conv2D(48, (3, 3), activation='relu', stride=(2, 2)))

        model.add(Conv2D(96, (3, 3), activation='relu'))
        model.add(Conv2D(96, (3, 3), activation='relu', stride=(2, 2)))
